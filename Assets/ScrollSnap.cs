...
///
/// please be sure to check off inertia in the scroll rect setting
using System;
...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollSnap
    {
        ...
        void Start()
        {
            ...
            if(_scroll_rect.viewport!=null)
                _scrollRectTransform = _scroll_rect.viewport.gameObject.GetComponent<RectTransform>();
            else
        ...
        void LateUpdate()
        {
            ...
            if (_lerp)
            {
                ...
                _listContainerTransform.localPosition = Vector3.Lerp(_listContainerTransform.localPosition, _lerpTarget, 8.0f * Time.deltaTime);
        ...
        private void NextScreenCommand()
        {
            ...
            }else if(_pageOnDragStart == _pages - 1)
            {
                _lerp = true;
                _lerpTarget = _pageAnchorPositions[_pages - 1];
            }
        }
        ...
        public int CurrentPage()
        {
            ...
            return Mathf.Clamp(Mathf.RoundToInt(page), 0, _pages-1);
        }
